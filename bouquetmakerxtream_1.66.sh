...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing  bouquetmakerxtream_1.66   #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1711/refs/heads/main/enigma2-plugin-extensions-bouquetmakerxtream_1.66.20251113_all.ipk"
IPK_NAME="enigma2-plugin-extensions-bouquetmakerxtream_1.66.20251113_all.ipk"
