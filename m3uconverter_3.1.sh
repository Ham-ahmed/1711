...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing  m3uconverter_3.1     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1711/refs/heads/main/enigma2-plugin-extensions-m3uconverter_3.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-m3uconverter_3.1_all.ipk"
